...
func _ready():
	if GlobalVars.opened_micah_case == true:
		...
		hide_open_case()
		show_closed_case()
	if Dialogic.VAR.get_variable("Asked Questions.Micah_Asked_Key") == false and GlobalVars.viewed_Micah_key == true:
		GlobalVars.viewed_Micah_key = false
	if Dialogic.VAR.get_variable("Asked Questions.Micah_asked_letter") == false and GlobalVars.viewed_Micah_letter == true:
		GlobalVars.viewed_Micah_letter = false
	# Dialogic.VAR.get_variable("Asked Questions.Micah_asked_letter") == false:
		#print("enterededed")
		#GlobalVars.viewed_Micah_key = false
		#GlobalVars.viewed_Micah_letter = false
